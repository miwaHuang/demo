...
(function ($) {
    ...
    function _1dd(_1de, _1df) {
        ...
        //josh
        if (_1df) {
            if ($(_1de).hasClass("J_Overflow")) {
                var cont_height = ($(_1de).find(".J_Overflow_Tab").size() > 0) ? _1df.height - 65 - 45 : _1df.height - 65;
                $(_1de).find(".J_Overflow_Cont").css({ "height": cont_height, "overflow-y": "auto" });
            }
        ...
        if (!isNaN(opts.width)) {
            ...
            //_1e0.width("auto");
            _1e0.width(document.body.clientWidth);
        }
    ...
    function _1ef(_1f0) {
        ...
        var method = (opts.PostData != undefined) ? "POST" : "GET";
        if (opts.href) {
    ...
    $.fn.panel.parseOptions = function (_228) {
        var t = $(_228);
        return $.extend({}, $.parser.parseOptions(_228, ["id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", "tools", "href", "PostData", { cache: "boolean", fit: "boolean", border: "boolean", noheader: "boolean" }, { collapsible: "boolean", minimizable: "boolean", maximizable: "boolean" }, { closable: "boolean", collapsed: "boolean", minimized: "boolean", maximized: "boolean", closed: "boolean" }]), { loadingMessage: (t.attr("loadingMessage") != undefined ? t.attr("loadingMessage") : undefined) });
    };
    $.fn.panel.defaults = {
        id: null, title: null, iconCls: null, width: "auto", height: "auto", left: null, top: null, cls: null, headerCls: null, bodyCls: null, style: {}, href: null, PostData: null, cache: true, fit: false, border: true, doSize: true, noheader: false, content: null, collapsible: false, minimizable: false, maximizable: false, closable: false, collapsed: false, minimized: false, maximized: false, closed: false, tools: null, href: null, loadingMessage: "Loading...", extractor: function (data) {
            var _229 = /<body[^>]*>((.|[\n\r])*)<\/body>/im;
    ...
    function _255(_256) {
        ...
        if (opts.toolbar) {
            if ($.isArray(opts.toolbar)) {
                ...
                if ($(_256).find("div.dialog-toolbar") != undefined && $(_256).find("div.dialog-toolbar").attr("id") != $(opts.toolbar).attr("id"))
                    $(_256).find("div.dialog-toolbar").remove();
        ...
        var _25d = opts.PostData;
        opts.href = null;
        opts.content = null;
        _257.panel({
            closed: opts.closed, cache: opts.cache, href: _25b, content: _25c, PostData: _25d, onLoad: function () {
                if (opts.height == "auto") {
                    $(_256).window("resize");
                }
...
(function ($) {
    ...
    function _26f(_270) {
        ...
        }, { title: "", width: 250, height: 160, showType: "slide", showSpeed: 600, msg: "", timeout: 4000 }, _270);
    ...
    $.messager = {
        show: function (_276) {
            ...
            return win;
        }, confirm: function (_27a, msg, fn, ok_txt, cancel_txt) {
            var _27b = "<div class=\"messager-icon messager-question\"></div>" + "<div>" + msg + "</div>" + "<div style=\"clear:both;\"/>";
            var _27c = {};

            ok_txt = (ok_txt != undefined) ? ok_txt : $.messager.defaults.ok;
            cancel_txt = (cancel_txt != undefined) ? cancel_txt : $.messager.defaults.cancel;

            _27c[ok_txt] = function () {
                win.window("close");
                if (fn) {
                    fn(true);
                    return false;
...
(function ($) {
    ...
    function _4f7(_4f8, _4f9, _4fa) {
        ...
        function _4fb(trs1, trs2) {
            ...
            while (i--) {
                ...
                _501 = max(tr1.height(), tr2.height());
                tr1.css("height", _501);
                tr2.css("height", _501);
                if (i == 0)
                    break;
    ...
    function _517(_518) {
        ...
        function _51d(_522, _523, _524) {
            ...
            var pos;
            while (i < _523_len) {
                tr = $("<tr class=\"datagrid-header-row\"></tr>").appendTo($("tbody", t));
                cols = _523[i];
    ...
    function _5f6(_5f7) {
        ...
        var _5f9 = [];
        //josh
        var rows_len = rows && rows.length ? rows.length : 0;
        var i = 0;
        while (i < rows_len) {
    ...
    var _688 = {
        render: function (_689, _68a, _68b) {
            ...
            //josh 原本for改為while(while速度比for快很多)
            var rows_len = rows && rows.length ? rows.length : 0;
            var i = 0;
            while (i < rows_len) {
            ...
            while (i < _699_len) {
                _69e = _699[i];
                col = $(_698).datagrid("getColumnOption", _69e);
                if (col) {
                    _69f = _69c[_69e];
                    css = col.styler ? (col.styler(_69f, _69c, _69b) || "") : "";
                    _6a0 = "";
                    _6a1 = "";
                    if (typeof css == "string") {
                        _6a1 = css;
                    ...
                    cls = _6a0 ? "class=\"" + _6a0 + "\"" : "";
                    _6a2 = col.hidden ? "style=\"display:none;" + _6a1 + "\"" : (_6a1 ? "style=\"" + _6a1 + "\"" : "");
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "讀取中...", rownumbers: false, singleSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, FirstLoadPage: true, rowStyler: function (_6c3, _6c4) {
...
(function ($) {
    function _7f2(_7f3, _7f4) {
        ...
        var parent_width = ($(_7f3).parents(".cssm-datebox-container").width() != null) ? $(_7f3).parents(".cssm-datebox-container").width() : 0;
        //_7f6._outerWidth(opts.width)._outerHeight(34);
        _7f6._outerHeight(34);
        //_7f8._outerWidth(_7f6.width()-_7fa);
        _7f8._outerWidth((parent_width != 0) ? (parent_width - _7fa) : (_7f6.width() - _7fa));
    ...
    function _80a(_80b) {
        ...
        if (!opts.disabled && !opts.readonly) {
            _80f.bind("click.combo", function (e) {
                ...
                //josh,easyui combo change event
                var q = _80f.val();
                if (_80c.previousValue != q) {
                    _80c.previousValue = q;
                    $(_80b).combo("showPanel");
                    opts.keyHandler.query.call(_80b, _80f.val(), "");
                    $(_80b).combo("validate");
                }
            });
